...
const ROWS = [
  [
    { title: "Programming Languages", items: ["C", "C++", "Java", "JavaScript", "PHP"] },
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "React (Basics)"] },
    { title: "Databases & Tools", items: ["MySQL", "Git", "GitHub", "VS Code"] },
    { title: "Frameworks & Libraries", items: ["React (Basics)"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Time Management", "Leadership", "Teamwork", "Communication"],
    },
  ],
];
...
export default function Skills() {
  ...
  return (
    <section className="min-h-screen bg-black text-white py-20 px-8 flex flex-col items-center">
      <motion.div
